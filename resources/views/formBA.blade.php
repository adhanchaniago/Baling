    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header"><h3 class="text-center font-weight-light my-4">Input Berita Acara</h3></div>
                <div class="card-body">
                    <form method="post" action="{{ route('beritaacara.store') }}">
                        {{ csrf_field() }}
                      <div class="form-row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <label class="small mb-1" for="inputPassword">ID Laporan*</label>
                                  <input class="form-control py-4" name="request_id" id="request_id" type="text" placeholder="Masukan ID Laporan" required/>
                              </div>
                          </div>
                          <div class="col-md-6">
                              <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" name="costumer" id="costumer" type="text" placeholder="Masukan nama nasabah" required />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputLastName">No Costumer</label>
                                    <input class="form-control py-4" name="no_costumer" id="no_costumer" type="text" placeholder="Masukan No Costumer"/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputLastName">No Rekening</label>
                                    <input class="form-control py-4" name="no_rekening" id="no_rekening" type="text" placeholder="Masukan No Rekening" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputLastName">No Kartu*</label>
                                    <input class="form-control py-4" name="no_kartu" id="no_kartu" type="text" placeholder="Masukan No Kartu" required/>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" name="status" id="status" type="text" placeholder="Masukan status" required />
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputFirstName">Transaction Time*</label>
                                    <input class="form-control py-4" name="transaction_time" id="transaction_time" type="text" placeholder="Masukan waktu transaksi" required/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputLastName">Created On*</label>
                                    <input class="form-control py-4" name="created_on" id="created_on" type="text" placeholder="Masukan created on laporan" required/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
<script type="text/javascript">
  $(document).on("click", ".modalKonfirmasi", function () {
      ...
      var status=$('#category').val(); //get the value..
      ...
      var created_on=$('#created_on').val(); //get the value..
      $("#modalKonfirmasi").find('input[name="modal-created_on"]').val(created_on); //set the valu
      $("#label_created_on").text(created_on);
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
                  ...
                  <label id="label_created_on" class="control-label"></label>
                  <input name="modal-created_on" id="modal-created_on" type="text"  style="display: none;"/>
            </div>
            <div class="form-group">
